    ...
    public WebDriver getLocalDriver(@Optional("mac") String OS, String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (OS.equalsIgnoreCase("OS X")) {
                ...
                System.setProperty("webdriver.chrome.driver", "/Users/zuha/IdeaProjects/GroupProject/Generic/src/main/java/drivers/chromedriver");
            }
            ...
            if (OS.equalsIgnoreCase("OS X")) {
                ...
                System.setProperty("webdriver.gecko.driver", "/Users/zuha/IdeaProjects/GroupProject/Generic/src/main/java/drivers/chromedriver");
            }
